...
Connector* connector;
uint_fast16_t __file_size, __file_exists, __file_content;
uint_fast16_t __file, __file_read, __file_readln, __file_write, __file_writeln, __readbyte, __readstring, __writebyte, __writestring, __file_eof, __file_size_alt, __file_close;
...
string read_file(string filename) {
    /* THIS COMMENTED CODE WILL BE DELETED SOON.
